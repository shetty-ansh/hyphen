...
const GALLERY_IMAGES = [
    ...
    { id: 8, url: "/images/image-8.png", alt: "hyphen 8", className: "col-span-2 row-span-1" }, // Landscape (Real)
    { id: 11, url: "/images/image-11.png", alt: "hyphen 11", className: "col-span-1 row-span-1" }, // Square (AI)
    { id: 9, url: "/images/image-9.png", alt: "hyphen 9", className: "col-span-2 row-span-1" }, // Landscape (Real)
